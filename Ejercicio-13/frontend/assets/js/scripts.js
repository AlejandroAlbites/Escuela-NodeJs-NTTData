(function (window, document) {
  ...
  function createPdf(
    ...
    fetch("http://localhost:3000/dev/create-pdf", requestOptions)
      ...
      .then((blob) => {
        ...
        link.setAttribute(
          "download",
          pdfName + "-" + date.getDate() + date.getMonth() + date.getFullYear()
        );
  ...
  async function handleSubmit(e) {
    ...
    let proposalShortDescription = document.getElementById(
      "proposalShortDescription"
    ).value;
  ...
  function handleAddService(e) {
    ...
    const formServicesItemLength = document.querySelectorAll(
      ".form-services__item"
    ).length;
    ...
    $delButton.innerHTML =
      '<button type="button" class="delete btn-remove-service">Remove</button>';
  ...
  function handleSelectServicesType(e) {
    ...
    if (targetValue === "hour") {
      document
        .getElementById("serviceHours")
        .setAttribute("placeholder", "Hours");
      document
        .getElementById("serviceCostHour")
        .setAttribute("placeholder", "Cost per Hour");
    }
    if (targetValue === "quantity") {
      ...
      document
        .getElementById("serviceCostHour")
        .setAttribute("placeholder", "Unity Price");
    }
  }
